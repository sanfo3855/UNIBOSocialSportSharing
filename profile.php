...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid bg-1 text-center"style=" padding-left: 30px; padding-right: 30px">    
            <div class="row">
                <div class="col-md-3 well"style=" background-color: #cccccc; border-color: #ccccccs">
                    <?php
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="title"style=" color: #b52c27">Profilo</h4>
                                    </div>
                                    <div class="modal-body">
                                        <center>
                                            <img src="<?php echo $fotoUtente["Foto"] ?>" name="aboutme" width="140" height="140" border="0" class="img-circle"></a>
                                            <h3 class="media-heading"style=" color: #b52c27"><?php echo $_SESSION["nome_utente"] . " " . $_SESSION["cognome_utente"] ?><br><small><?php echo $_SESSION["nome_corso_studi"] ?></small>
