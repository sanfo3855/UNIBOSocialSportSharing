...
<html lang="en">
    ...
    <body>
        ...
        <
        <div class="container-fluid bg-1 text-center well"style=" padding-top: 20px; background-color: #b52c27; padding-left: 40px;padding-right: 30px">    
            <div class="row">
                <div class="col-sm-3 well"style=" background-color: #cccccc; border-color: #cccccc">
                    <?php
                    ...
                    <a href="#aboutModal" data-toggle="modal" data-target="#myModal"><img src="<?php echo $fotoUtente["Foto"] ?>" class="img-circle" height="120" width="120" alt="Avatar">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="title">Profilo</h4>
                                    </div>
                                    <div class="modal-body">
                                        <center>
                                            <img src="<?php echo $fotoUtente["Foto"] ?>" name="aboutme" width="140" height="140" border="0" class="img-circle"></a>
                                            <h3 class="media-heading"><?php echo $_SESSION["nome_utente"] . " " . $_SESSION["cognome_utente"] ?><br><small><?php echo $_SESSION["nome_corso_studi"] ?></small>
                        ...
                        <p><h5><small><i>Clicca la foto per le informazioni personali</i></small></h5></p>
                        <br><br><br><br>
                        <div
                        <?php if ($_SESSION["tipo_utente"] == "UP") {
                            ?>
                                <button type="button" class="btn btn-primary btn-lg"style="   background-color: #b52c27; border-color: #b52c27">Crea Partita</button>;
                                <?php }
                                ?>
                        </div>         
                </div>
        ...
        <div class="container-fluid bg-3 text-center well"style=" padding-top: 20px; padding-left: 30px;padding-right: 30px">
            <div>
                <?php
                require 'connection.php';
